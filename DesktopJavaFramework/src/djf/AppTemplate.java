...
import djf.components.mapWelcomeComponent;
import djf.ui.*;
...
public abstract class AppTemplate extends Application {
    ...
    protected mapWelcome mapWelcomeStage;
    ...
    //protected mapWelcomeComponent mapWelcomeComponent;
...
//    public mapWelcomeComponent getWelcomeComponent(){
//        return mapWelcomeComponent;
//    }
    ...
    public void start(Stage primaryStage) {
        ...
        try {
            ...
            if (success) {
                ...
                mapWelcomeStage = new mapWelcome(gui);
