...
public class AppGUI {
    ...
    public void updateToolbarControls(boolean saved) {
        ...
        // THE CUT COPY PASTE BUTTONS ARE APP-DEPENDENT
    ...
    private void initFileToolbar() {
        ...
        if (isTrue(HAS_SAVE_AS)) {
            saveAsButton = initToolBarChildButton(fileToolbar, SAVE_AS_BUTTON_PREFIX, DISABLED);
            saveAsButton.setOnAction(e -> fileController.processSaveAsRequest());
        }
        if (isTrue(HAS_EXPORT)) {
            exportButton = initToolBarChildButton(fileToolbar, EXPORT_BUTTON_PREFIX, DISABLED);
